            ...
            <section class="ts-section">
                <div class="ts-container">
                    ...
                    <div class="ts-about-text">
                        <p>АВД ГРУПП — застройщик из Перми. Мы специализируемся на кирпичных домах блокированной застройки и выпускаем их в свет «под ключ»: с благоустроенной закрытой территорией, детской площадкой и готовой инфраструктурой.</p>
                        <p>Всю строительную историю мы прошли в регионе: от первых построенных объектов до сданного комплекса на ул. Вольская, 29. Ценим репутацию — объекты вводим в срок, цены держим честными, а каждую сделку сопровождаем лично: от заявки до вручения ключей.</p>
                    </div>
