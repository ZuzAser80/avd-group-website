const Frontpage = {
    template: `
        <div class="-1">
            ...
            <!-- Герой -->
            <div class="hero-10">
                <img src="/static/images/cover.png" class="1-1-11" alt="Фон" style="display:none;" />
            ...
            <div class="about-17">
                <div class="frame-1-18">
                    ...
                    <img src="/static/images/house.PNG" class="2-1-20" alt="О компании" style="max-width:100%; border-radius:8px;" />
            ...
            <div class="info-34">
                ...
                <img src="/static/images/monochrome_logo.png" class="1-37" alt="Логотип" style="height:60px;" />
            </div>
        </div>
    `
};