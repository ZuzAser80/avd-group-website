        ...
        <div class="-1">
            <div class="header-2">
                <div class="container-3">
                    <img src="/static/images/logo.png" class="1-4" alt="АВД ГРУПП" />
                    ...
                    <p class="menu"><span class="text-rgb-181-85-47">Главная</span></p>
                    <router-link to="/projects" class="prototype-link"><p class="menu"><span class="text-rgb-50-50-50">Объекты</span></p></router-link>
                    <p class="text-9"><span class="text-rgb-207-120-85">+7 902 80 32 835</span></p>
                </div>
            </div>
            <div class="hero-10">
                <img src="/static/images/cover.png" class="1-1-11" alt="Фон" />
                <p class="h1"><span class="text-white">МЫ ВЕРИМ, ЧТО ОТВЕТСТВЕННОЕ И КАЧЕСТВЕННОЕ ВЫПОЛНЕНИЕ РАБОТ СОЗДАЮТ ДОВЕРИЕ</span></p>
                <p class="h3"><span class="text-rgb-207-120-85">Строим с 2013 года</span></p>
            ...
            <div class="about-17">
                <div class="frame-1-18">
                    <p class="h2"><span class="text-rgb-181-85-47">О компании</span></p>
                    <img src="/static/images/house.PNG" class="2-1-20" alt="О компании" />
            ...
            <div class="advantages-23">
                <p class="h2"><span class="text-white">Почему выбирают нас?</span></p>
                <div class="rectangle-1-25">
                    <p class="h3"><span class="text-rgb-181-85-47">Опыт с 2013 года</span></p>
                ...
                <div class="rectangle-2-26">
                    <p class="h3"><span class="text-rgb-181-85-47">Качество и ответственность</span></p>
                ...
                <div class="rectangle-3-29">
                    <p class="h3"><span class="text-rgb-181-85-47">Соблюдение сроков</span></p>
            ...
            <div class="info-34">
                ...
                <img src="/static/images/monochrome_logo.png" class="1-37" alt="Логотип" />
            </div>
        </div>
    `
};