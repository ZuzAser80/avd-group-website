        ...
        <div class="pd">
            ...
            <div class="pd-section pd-form-sec" id="pd-form">
                <div class="pd-container pd-form-wrap">
                    ...
                    <p class="pd-form-note">Нажимая «Записаться», вы соглашаетесь на обработку персональных данных. Передайте заявку — мы перезвоним в течение рабочего дня: 8 (908) 25-85-888.</p>
                </div>
            </div>
            ...
            <div class="info-34">
                <div class="info-wrap">
                    <div class="info-text">
                        ...
                        <p class="body"><span class="text-white">Застройщик: ООО «Специализированный застройщик СК „Рост-Строй“»<br>ИНН 5903124969 · ОГРН 1165958080199 · 614000, Пермский край, г. Пермь, ул. Окулова, д. 27 оф. 103<br>тел. 8 (908) 25-85-888 · avd_grupp@mail.ru</span></p>
                    </div>
